...
class TestValidateResources(unittest.TestCase):
    ...
    def test_resource_normal_container(self):
        ...
        self.assertEqual((1, 0, 1024 ** 3),
                         rv.get_user_resource_usage_in_group(dict(name=_TEST_GROUP), dict(name=_TEST_USER)))
    ...
    def test_user_resource_usage(self):
        ...
        self.assertEqual((1.5, 1, 1024 ** 3 * 2),
                         rv.get_user_resource_usage_in_group(dict(name=_TEST_GROUP), dict(name=_TEST_USER)))
    ...
    def test_validate_resources_with_cpu_conversion(self):
        ...
        user_cpu_usage, user_gpu_usage, user_memory_usage = rv.get_user_resource_usage_in_group(dict(name=_TEST_GROUP),
                                                                                                dict(name=_TEST_USER))
        group_usage = {
            'cpu': group_cpu_usage,
            'gpu': group_gpu_usage,
